...
const Input = ({ label, name, type, value, placeholder, icon: Icon, error, disabled, register }: InputProps) => {
      ...
      <div className="w-full flex items-center justify-between">
        <div className="flex items-center w-full relative">
          ...
          <input
            {...register}
            name={name}
            type={type == 'password' ? (passwordVisible ? 'string' : 'password') : type}
            ...
            className={cn(
              ...
              error ? 'border-destructive focus:border-destructive' : 'border-input focus:border-secondary',
