...
const Switch = ({ label, descriptions, disabled, error, value, setValue }: SwitchProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn('w-10 h-6 flex items-center bg-foreground/30 rounded-full cursor-pointer shadow-inner', {
      ...
      >
        <div
          className={cn(
            ...
            toggleSwitch ? 'translate-x-[100%] bg-foreground' : 'translate-x-0 bg-foreground/90'
          )}
        />
      </div>
    </div>
