        ...
        <div className="flex flex-col-reverse lg:flex-row gap-6 2xl:gap-10 items-start pt-12 mb-8">
            ...
            {FOOTER_INFOS.map((section, i) => (
              <div key={i} className="flex flex-col gap-2">
                ...
                {section.links.map((link) => (
                  <Link to={link.link} key={link.title} className="flex items-center gap-2 group cursor-pointer">
          ...
          <div className="w-full md:basis-[40%] flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-2">
              <h2 className="text-lg md:text-xl font-semibold mb-2 pb-2 pr-4 border-b border-border w-fit">Contacts</h2>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="group-hover:translate-x-1 duration-300 overflow-hidden flex items-center">
                        ...
                        <div className="-translate-x-5 group-hover:translate-x-0">{contact.title}</div>
                      </div>
                    </Link>
                  );
                })}
