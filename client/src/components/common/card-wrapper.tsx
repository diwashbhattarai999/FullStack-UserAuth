...
const CardWrapper = ({
  ...
  return (
    <div
      className={cn(
        'w-full min-h-screen flex items-center justify-center bg-background/60 backdrop-blur-md',
    ...
    >
      ...
      >
        ...
        <div className="w-full pb-4 text-center border-b border-border">
          ...
          <div className="text-lg text-secondary-foreground">{subHeaderLabel}</div>
        </div>
        <div
